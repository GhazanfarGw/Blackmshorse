...
export default function focus() {
  return (
    <>
    <section id='focus' className='mx-auto justify-center scroll-smooth duration-500 text-[#e0e0e0] lg:pt-20 sm:pt-0 pt-0'>
            ...
            <div className='mx-auto text-[#000]'>
                <div className='lg:pt-5 sm:pt-20 pt-10'>
                    ...
                    <div className='lg:flex lg:grid-cols-2 justify-end lg:gap-x-10 mx-auto lg:pt-10 sm:pt-5 pt-3'>
                        ...
                        <p className='lg:max-w-3xl tracking-wide text-sm sm:text-base lg:text-lg text-[#000000] lg:pt-0 sm:pt-5 pt-3'>
