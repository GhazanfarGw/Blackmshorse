...
function Logo({ isScrolled }) {
  ...
  return (
    <>
      ...
      {isScrolled ? (
        <header className="fixed z-10 md:px-10 px-3 w-full duration-300 mx-auto items-center bg-[#fff] text-black overflow-x-hidden shadow-md md:py-2 scroll-smooth">
        <div onClick={handleScrollToTop} className="mx-auto items-center overflow-x-hidden">
          <div className='hidden md:block lg:block'>
            <div className='flex items-center mx-auto'>
              <img width={25} src='./call.png' alt='phone_logo'/>
              <h1 className='text-lg font-sans font-semibold'>+44 7375 150590</h1>
            </div>
          </div>
                ...
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
                  <div className='flex pl-8 items-center'>
                    <a
                      ...
                      items-center text-base md:hover:border-b border-[#d8bb6c] relative h-8 pt-0.5 duration-200 lg:px-4 md:px-2 px-4 flex justify-center flex-row tracking-wide"
                    >
                      Home
                    </a>
                    <a
                  ...
                  <div>
                    <a 
                      href="/" className="items-center text-base md:hover:border-b bg-[#d8bb6c] border-[#d8bb6c] relative h-8 pt-0.5 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row tracking-wide">
                      Contact Us
                    </a>
                  </div>
                </div>
          ...
          <div className="flex items-center">
            <div className="flex items-center w-full">
              <div className="flex-shrink-0 md:py-2 items-center duration-200">
                <a href="/">
                  ...
                  <img width={185} className='items-center md:hidden block lg:hidden duration-200' src='./black.png' alt='favicon.png'/>
                </a>
              </div>
              <div className="hidden lg:block w-full duration-200 scroll-smooth">
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
            ...
            <div className="mr-2 flex lg:hidden">
              <button
                onClick={() => setIsOpen(!isOpen)}
                type="button"
                className="py-3 inline-flex items-center justify-center duration-200 rounded-md text-[#000]"
                aria-controls="mobile-menu"
                aria-expanded="false"
              >
                <span className="sr-only">Open main menu</span>
