            ...
            <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
              ...
              <div className="hidden lg:block w-full duration-200 scroll-smooth">
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
                  ...
                  <div>
                    <a 
                      href="/" className="items-center text-base font-semibold border hover:bg-black text-black hover:text-white border-[#000] relative h-8 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row tracking-wide">
                      Contact Us
                    </a>
                  </div>
                </div>
            ...
            <div className="flex items-center w-full">
              ...
              <div className="hidden lg:block w-full duration-200 scroll-smooth">
                <div className="items-center flex duration-200 justify-end mx-auto gap-x-10">
                  ...
                  <div>
                    <a 
                      href="/" className="items-center text-base border hover:bg-[#000] hover:border-[#000] border-[#fff] relative h-8 duration-200 lg:px-10 md:px-6 px-4 flex justify-center flex-row tracking-wide">
                      Contact Us
                    </a>
                  </div>
                </div>
